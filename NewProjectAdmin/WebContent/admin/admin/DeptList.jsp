...
<!--     <meta name="keywords" content="Bootstrap 3, Template, Theme, Responsive, Corporate, Business"> -->
	...
	function find(sel) {
		...
		if (sel == "id") {
			menu.innerHTML = "부서명 검색<span class='fa fa-caret-down' value='dept_name'></span>";
			abc.value="dept_name"
		} else if (sel == "name") {
			menu.innerHTML = "부서 설명 검색<span class='fa fa-caret-down' value='dept_desc'></span>";
			abc.value="dept_desc"
		}
	}
             ...
             <div class="input-group margin">
                 <div class="input-group-btn">
                     ...
                     <ul id="menu" class="dropdown-menu" name="searchColumn">
                         <li><a onclick="find('id')" >부서명 검색</a></li>
                         <li><a onclick="find('name')">부서 설명 검색</a></li>
                     </ul>
                 </div>
