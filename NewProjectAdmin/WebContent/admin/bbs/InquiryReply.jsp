...
<head>
   ...
   <link rel="shortcut icon" href="${pageContext.request.contextPath}/bootstrap/img/favicon.png"/>
	...
	function goNoticeInsert(){
		...
		else if(document.getElementById("content").value.length > 2000){
  ...
  <body>
    <c:import url="/template/Header.jsp" />
   		...
   		<div class="container">
				  ...
				  <h2>1:1문의 답장</h2><br/><br/>
				    <form action="<c:url value='/Bbs/InquiryReply.do'/>" method="post">
				      	  ...
				      	  <tbody>
					      	  ...
					      	  <tr>
					      	  		...
					      	  		<td>
								      	<div class="col-xs-5">
								        <input type="text" class="form-control"  name="receiver" id="receiver_id" value="${dto.smem_id}"/>
								     	</div>
					      	  		</td>
					      	  </tr>
					      	  <tr>
					      	  		...
					      	  		<td>
								      	<div class="col-xs-5">
								        <input type="text" class="form-control"  name="title" id="title_id" value="[소카]1:1문의에 대한 답변"/>
								     	</div>
					      	  		</td>
					      	  </tr>
					      	  <tr>
					      	  		...
					      	  		<td>
					      	  			<textarea name="content" id="content_id" rows="20" cols="80" class="form-control"style="margin-left: 15px;">안녕하세요 쏘카입니다.
					      	  			</textarea>
				      ...
				      <button type="submit" class="btn btn-info" onclick="return goNoticeInsert()">보내기</button>
