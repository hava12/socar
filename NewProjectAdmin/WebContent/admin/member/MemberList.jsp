              ...
              <tbody>
                ...
                <c:if test="${not listSimpleMem}">
                		<c:forEach items="${list}" var="item">
	                		<tr>
	                				<td align="center"><a href="<c:url value='/Member/MemberDetail.do' />?smem_id=${item.smem_id}">${item.smem_id }</a></td>
	                				<td align="center"><a href="<c:url value='/Member/MemberDetail.do' />?smem_id=${item.smem_id}">${item.smem_name }</a></td>
	                				<td align="center"><a href="<c:url value='/Member/MemberDetail.do' />?smem_id=${item.smem_id}">${item.smem_tel }</a></td>
	                				<td align="center"><a href="<c:url value='/Member/MemberDetail.do' />?smem_id=${item.smem_id}">${item.smem_pwd }</a></td>
	                				<td align="center"><a href="<c:url value='/Member/MemberDetail.do' />?smem_id=${item.smem_id}">${item.smem_date }</a></td>
	                		</tr>
                		</c:forEach>
                </c:if>
              </tbody>
