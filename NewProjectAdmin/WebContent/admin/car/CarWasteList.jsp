...
<head>
   ...
   <link rel="shortcut icon" href="${pageContext.request.contextPath}/bootstrap/img/favicon.png"/>
	...
	function find(sel) {
		...
		if (sel == "id") {
			menu.innerHTML = "폐차 일련번호 검색<span class='fa fa-caret-down' value='car_i_code'></span>";
			abc.value="car_i_code"
		} else if (sel == "name") {
			menu.innerHTML = "폐차 사유검색<span class='fa fa-caret-down' value='car_w_reason'></span>";
			abc.value="car_w_reason"
		}
	}
          ...
          <div class="table-responsive">
            ...
            <table class="table table-bordered table-striped">
              ...
              <thead>
                ...
                <tr>
                  <th style="text-align: center; width: 20%">차량일련번호</th>
                  <th style="text-align: center; width: 20%">폐차일</th>
                  <th style="text-align: center; width: 60%">폐차사유</th>               
                </tr>
             ...
             <div class="input-group margin">
                 <div class="input-group-btn">
                     ...
                     <ul id="menu" class="dropdown-menu" name="searchColumn">
                         <li><a onclick="find('id')" >폐차 일련번호 검색</a></li>
                         <li><a onclick="find('name')">폐차 사유 검색</a></li>
                     </ul>
                 </div>
