...
<head>
   ...
   <link rel="shortcut icon" href="${pageContext.request.contextPath}/bootstrap/img/favicon.png"/>
	...
	function find(sel) {
		...
		if (sel == "id") {
			menu.innerHTML = "차량명 검색<span class='fa fa-caret-down' value='car_name'></span>";
			abc.value="car_name"
		} else if (sel == "com") {
			menu.innerHTML = "제조사 검색<span class='fa fa-caret-down' value='car_com'></span>";
			abc.value="car_com"
		}
		else if (sel == "trans") {
			menu.innerHTML = "연료 정보 검색<span class='fa fa-caret-down' value='car_trans'></span>";
			abc.value="car_trans"
		}
		else if (sel == "max") {
			menu.innerHTML = "승차 정원 검색<span class='fa fa-caret-down' value='car_max_per'></span>";
			abc.value="car_max_per"
		}
	}
          ...
          <div class="table-responsive">
            ...
            <table class="table table-bordered table-striped">
              ...
              <thead>
                ...
                <tr>
                  <th style="text-align: center; width: 15%">차량명 코드</th>
                  <th style="text-align: center; width: 15%">차량 타입 코드</th>
                  <th style="text-align: center; width: 20%">차랑명</th>
                  <th style="text-align: center; width: 20%">제조사</th>
                  <th style="text-align: center; width: 15%">연료정보</th>
                  <th style="text-align: center; width: 15%">승차정원</th>
                </tr>
             ...
             <div class="input-group margin">
                 <div class="input-group-btn">
                     ...
                     <ul id="menu" class="dropdown-menu" name="searchColumn">
                         <li><a onclick="find('id')" >차량명 검색</a></li>
                         <li><a onclick="find('com')">제조사 검색</a></li>
                         <li><a onclick="find('trans')">연료정보 검색</a></li>
                         <li><a onclick="find('max')">승차 정원 검색</a></li>
                     </ul>
                 </div>
