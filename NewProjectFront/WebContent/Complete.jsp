...
<head>
		...
		<script type="text/javascript" src="/template/asset/js/ssun.js?1505974379"></script>
		<script type="text/javascript" src="/template/asset/js/json3.min.js?1505974379"></script>
		<script type="text/javascript" src="/template/asset/js/common.js?1505974379"></script>
		<script type="text/javascript" src="/template/asset/js/day-picker.js?1505974379"></script>
		<script type="text/javascript" src="/template/asset/js/jquery.block.ui.min.js?1505974379"></script>
		<script>
...
$(function(){
	set_cookie('complete_way', null);
	set_cookie('complete_start_at', null);
	set_cookie('complete_end_at', null);
	set_cookie('complete_car_name', null);
	set_cookie('complete_car_num', null);
	set_cookie('complete_rent_time', null);
	set_cookie('complete_zone_name', null);
	set_cookie('complete_zone_address', null);
...
<body id="reservation" class="complete">
<div id="wrap">
	<!-- header -->
	...
	<div id="header">
		...
		<div class="util">
			...
			<p class="hi-seoul"><a href=https://www.socar.kr/hi-seoul><img src='//web-assets.socar.kr/template/asset/images/common/header_car_sharing_n.gif' alt="공유서울 나눔카" /></a></p>
					...
					<ul>
					<li><a href=https://www.socar.kr/mypage class="util3">임형택 님</a></li>
	...
	<div id="container">
		<div id="content">
			<div class="box">
				<h2><img src='//web-assets.socar.kr/template/asset/images/reservation/complete_h2.gif' alt="예약이 완료되었습니다." /></h2>
				<p class="txt1"><img src='//web-assets.socar.kr/template/asset/images/reservation/complete_txt1.gif' alt="쏘카를 이용해주셔서 감사합니다. 차량 이용시 꼭! 안전 운전 해주세요." /></p>
				...
				<div class="group">
					...
					<br><a href="http://goo.gl/pXeXHY"><img src='//web-assets.socar.kr/template/asset/images/member/pc_appdown_new_160511.jpg' style="width:100%" /></a>
				</div>
			</div>
		</div>
...
<script type="text/javascript" src="/template/./asset/js/kakao.min.js?1505974379" charset="utf-8"></script>
<script type="text/javascript" src="/template/./asset/js/sns_interlocking.js?1505974379" charset="utf-8"></script>
