...
<!-- 											<li class="car2"><a href="#"><img src='${pageContext.request.contextPath}/template/image/car_title2.png' alt="쏘나타 하이브리드" /></a></li> -->
			...
			<!-- //map -->
					...
					<!-- list -->
					<div id="search_result_table" style="display: none;" class="list">
								...
								<!-- 반복부분  -->
										<div class="section_list"></div>
											<div class="section" style="display: none;">
													<div class="arti">
														<h4 class="zone_info_popup" value="5237">소카존이름</h4>
													...
													<!-- 기준요금이  할인가보다  클  경우에만  기준요금  표시 -->
														...
														<dl>
															<dt>SO회원 할인가</dt>
															<dd><strong id="price-s0"> 원</strong></dd>
														</dl>
...
<c:forEach items="${list}" var="item" varStatus="loop">
	...
	other_iwContent[${loop.count}] = '<div style="padding:5px;"><b>${item.soz_name}</b></div><div>${item.soz_loc}</div><div>운영차량: <span style="color:blue">${item.soz_i_car}</span>대/${item.soz_maxcar}대</div><div><a href="#" onclick="javascript:reserveResult(\'${item.soz_code}\');"><img src="//web-assets.socar.kr/template/asset/images/reservation/btn_able_socar.png" alt="예약가능 쏘카 보기"/></a></div>',
	iwRemoveable = true;
...
<c:url value="/Reserve/SearchResult.do?soz_code=${item.soz_code}"/>
</script>
