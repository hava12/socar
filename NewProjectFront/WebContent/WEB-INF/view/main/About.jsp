...
<head>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/template/js/ssun.js?1505265258"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/template/js/json3.min.js?1505265258"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/template/js/common.js?1505265258"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/template/js/day-picker.js?1505265258"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/template/js/jquery.block.ui.min.js?1505265258"></script>
		<script>
...
<link rel="stylesheet" type="text/css" href='${pageContext.request.contextPath}/template/css/common.css?v=20170731' />
<script type="text/javascript">
$(function(){
	//document.title = '회사소개 - (주)쏘카 :: 신개념 자동차 공유 서비스';
})
</script>
</head>

<body id="footerMenu" class="socar">
<div id="wrap">
		...
		<div id="content">
			<div class="box">
				<h2 style="position:relative;">
					<img src='${pageContext.request.contextPath}/template/image/socar_title.gif' alt="회사소개" />
					<a href="https://www.dropbox.com/sh/4kasqheoz9voc89/AABCuREidJphodi2F7ikU-K8a?dl=0" target="_blank">
						<span style="position: absolute;top: 8px;right: 0;font-weight: bold;font-size: 11px;color: #F68A8E;text-decoration: underline;">회사소개서 다운로드</span>
					</a>
				</h2>

				<div class="group">
					<h3><img src='${pageContext.request.contextPath}/template/image/socar_txt1.gif' alt="쏘카소개" /></h3>
					<p class="txt1"><img src='${pageContext.request.contextPath}/template/image/socar_txt2.gif' alt="쏘카는 자동차 사용에 대한 유연하고 합리적인 대안을 제시하는 사회혁신기업입니다." /></p>
					<p><img src='${pageContext.request.contextPath}/template/image/socar_txt3.gif' alt="쏘카는 경제적이고 환경친화적인 카셰어링 서비스를 제공함으로써 자동차 사용에 대한 유연하고 합리적인 대안을 제시하는 사회혁신기업입니다. 자동차 사용에 대한 보다 합리적인 소비 문화를 확산시킬 수 있도록 이용자 편의를 최우선 과제로 두고 있습니다." /></p>
				</div>

				<div class="group">
					<h3><img src='${pageContext.request.contextPath}/template/image/socar_txt4.gif' alt="쏘카 연혁" /></h3>
					<table cellspacing="0">
          <tr class="line">
						<th><img src='${pageContext.request.contextPath}/template/image/socar_txt_2016.gif' alt="2016" /></th>
						<td>
							<ol>
							<li><span>12</span> 업계 최초 공정거래위원회 '소비자중심경영(CCM) 인증' 획득</li>
							<li><span>09</span> 업계 최초 누적회원 200만명 돌파<br />글로벌 사회적 기업 'B Corp(Benefit Corporation)' 재인증 획득</li>
							<li><span>08</span> 편의점 CU와 카셰어링 관련 업무 협약(MOU) 체결<br />국내 카셰어링 업체 최초 차량 내 Wi-Fi 네트워크 서비스 제공</li>
							<li><span>07</span> 수익 공유형 장기 셰어링 서비스 '제로카셰어링' 론칭<br />세종시 공식 카셰어링 서비스 '어울링카' 사업자 선정</li>
							<li><span>06</span> 업계 최초 5천대 돌파<br />공유차량 딜리버리 서비스 '도어투도어(D2D)' 론칭</li>
							<li><span>05</span> 서울시 공식 카셰어링 서비스 '나눔카' 2기 사업자 선정</li>
							<li><span>04</span> 업계 최초 BMW 520d / X3 카셰어링 상용화<br />한국GM과 카셰어링 관련 업무 협약(MOU) 체결</li>
							<li><span>02</span> SK네트웍스 '스피드메이트' 차량 정비 부문 업무제휴<br />국내 카셰어링 업계 최초 앱 다운로드 150만 돌파</li>
							</ol>
						</td>
					</tr>
					<tr class="line">
						<th><img src='${pageContext.request.contextPath}/template/image/socar_txt_2015.gif' alt="2015" /></th>
						<td>
							<ol>
							<li><span>11</span> SK(주), 베인 캐피탈 등으로부터 650억 규모 시리즈B 투자 유치</li>
							<li><span>10</span> 2015 대한민국마케팅대상 공유경제 부문 최우수상 수상</li>
							<li><span>09</span> 업계 최초 누적회원 100만명 돌파</li>
							<li><span>08</span> 업계 최초 3천대 돌파</li>
							<li><span>05</span> 업계 최초 누적 이용건수 100만건 돌파</li>
							<li><span>04</span> 신개념 모바일 카풀 앱 '쏘카풀' 론칭<br />'미니5도어' 카셰어링 상용화</li>
							<li><span>02</span> 업계 최초 서비스 차량 2천대 돌파<br />전국 진출</li>
							</ol>
						</td>
					</tr>
					<tr>
						<th><img src='${pageContext.request.contextPath}/template/image/socar_txt_2014.gif' alt="2014" /></th>
						<td>
							<ol>
							<li><span>12</span> 업계 최초 50만 회원 돌파</li>
							<li><span>11</span> '프리우스' 카셰어링 상용화</li>
							<li><span>10</span> 베인캐피탈(Bain Capital)로부터 180억원 투자 유치</li>
							<li><span>09</span> 카셰어링서비스로서 세계 최초 글로벌 사회적 기업 'B Corp(Benefit Corporation) 인증' 획득<br />국내 유일 편도 서비스 론칭</li>
							<li><span>06</span> '스타렉스', '올란도' 카셰어링 상용화</li>
							<li><span>01</span> 업계 최초 연회비 페지<br />2013년을 빛낸 스타트업 100개 기업에 선정<br />통합회원 50,000명 돌파</li>
							</ol>
						</td>
					</tr>
					<tr>
						<th><img src='${pageContext.request.contextPath}/template/image/socar_txt5.gif' alt="2013" /></th>
						<td>
							<ol>
							<li><span>12</span> 대구, 경산, 울산, 양산, 김해, 창원 지역 서비스 오픈</li>
							<li><span>09</span> 부산 및 경기, 인천지역 서비스 오픈</li>
							<li><span>08</span> '콜라보레이티브 펀드(Collaborative Fund)'로부터 투자유치</li>
							<li><span>07</span> 쏘카 CI Design '2013 레드닷 디자인 어워드' 수상</li>
							<li><span>03</span> '쏘카' 서울시 공유기업 선정</li>
							<li><span>02</span> 쏘카 서비스 리뉴얼, 서울시 나눔카 서비스 오픈</li>
							<li><span>01</span> 서울광역자활센터, 세차업체지원 업무협약 체결<br />서울시 공식 카셰어링 사업자 선정, 업무협약 체결</li>
							</ol>
						</td>
					</tr>
					<tr>
						<th><img src='${pageContext.request.contextPath}/template/image/socar_txt6.gif' alt="2012" /></th>
						<td>
							<ol>
							<li><span>08</span> 세계자연보전총회 (WCC) 공식 차량 채택</li>
							<li><span>05</span> (주)다음커뮤니케이션 대상 기업 프로그램 실시</li>
							<li><span>03</span> 카셰어링 서비스 공식 론칭</li>
							<li><span>02</span> 홈페이지 오픈, 스마트폰 어플리케이션 출시</li>
							</ol>
						</td>
					</tr>
					<tr>
						<th><img src='${pageContext.request.contextPath}/template/image/socar_txt7.gif' alt="2011" /></th>
						<td>
							<ol>
							<li><span>12</span> 자동차 대여업 개시 신고 완료</li>
							<li><span>11</span> 현대자동차(주)와 카셰어링 관련 MOU 체결</li>
							</ol>
						</td>
					</tr>
					</table>
...
<!-- 				<div class="group">
					<h3><img src='${pageContext.request.contextPath}/template/image/socar_txt8.gif' alt="쏘카 팀" /></h3>
					<p class="thumb"><img src='${pageContext.request.contextPath}/template/image/socar_photo.jpg' alt="" /></p>
					<p class="txt2"><strong>The SOCAR team</strong> (from left to right):<br />bebe, hoy, yellonia, jay, swyoo,vavy, bebe, hoy, yellonia, jay, swyoo,vavy, bebe, hoy, yellonia, jay, swyoo,vavy</p>
					<div class="recuit">
						<h4><img src='${pageContext.request.contextPath}/template/image/socar_recruit_txt1.gif' alt="쏘카와 함께해요!" /></h4>
						<p><img src='${pageContext.request.contextPath}/template/image/socar_txt9.gif' alt="경제적인 카셰어링 쏘카와 함께  생각하고 경험할 팀원들을 기다리고 있습니다." /></p>
						<p class="btn"><a href="mailto:recruit@socar.kr"><img src='${pageContext.request.contextPath}/template/image/btn_recruit.gif' alt="recruit@socar.kr" /></a></p>
					</div>
				</div> -->
			</div>
		</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/template/js/kakao.min.js?1505265258" charset="utf-8"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/template/js/sns_interlocking.js?1505265258" charset="utf-8"></script>
