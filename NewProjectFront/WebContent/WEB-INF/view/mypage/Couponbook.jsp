	...
	<dd>이 쿠폰은 예고없이 종료될 수 있습니다</dd>
				...
				<div class="descript_wrapper">
					<div class="img_wrapper mobile">
						<img src='//dt0fe0zcu6ite.cloudfront.net/template/asset/images/couponbook/coupon_mobile1.png' style="width: 100%" />
					</div>
					<div class="img_wrapper mobile">
						<img src='//dt0fe0zcu6ite.cloudfront.net/template/asset/images/couponbook/coupon_mobile2.png' style="width: 100%" />
					</div>
				</div>
				...
				<div class="descript_wrapper">
					<div class="img_wrapper web">
						<img src='//dt0fe0zcu6ite.cloudfront.net/template/asset/images/couponbook/coupon_web1.png' style="width: 100%" />
						<a href="#" id="mycoupon" class="btn_01">내 쿠폰 확인하기</a>
					</div>
					<div class="img_wrapper web">
						<img src='//dt0fe0zcu6ite.cloudfront.net/template/asset/images/couponbook/coupon_web2.png' style="width: 100%;" />
